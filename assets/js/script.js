...
let jsonObject = window.json || {
    ...
    embed: {
        ...
        description: "You can use [links](https://www.madewith.me/server/) or emojis :smile: 😎\n```\nAnd also code blocks\n```",
        color: 0x41f097,
        timestamp: new Date().toISOString(),
        url: "https://www.madewith.me/server/",
        author: {
            name: "Author name",
            url: "https://www.madewith.me/server/",
        ...
        image: {
            url: "https://www.madewith.me/product/embed-builder/assets/media/banner.png"
        },
        footer: {
            text: "Footer text",
